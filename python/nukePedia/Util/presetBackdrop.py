...
def presetBackdrop():
    ...
    elif customPreset == 'CG:Ambient':
        presetLabel = 'CG: Ambient'
        presetIcon = 'Shader.png'
        presetColor = colorsys.hsv_to_rgb(0.062, 1, 0.5)
        
    elif customPreset == 'CG:Diffuse':
        presetLabel = 'CG: Diffuse'
        presetIcon = 'Shader.png'
        presetColor = colorsys.hsv_to_rgb(0.062, 1, 0.5)
        
    elif customPreset == 'CG:Reflection':
        presetLabel = 'CG: Reflection'
        presetIcon = 'Shader.png'
        presetColor = colorsys.hsv_to_rgb(0.062, 1, 0.5)
        
    elif customPreset == 'CG:Refraction':
        presetLabel = 'CG: Refraction'
        presetIcon = 'Shader.png'
        presetColor = colorsys.hsv_to_rgb(0.062, 1, 0.5)
        
    elif customPreset == 'CG:Shadow':
        presetLabel = 'CG: Shadow'
        presetIcon = 'Shader.png'
        presetColor = colorsys.hsv_to_rgb(0.062, 1, 0.5)
        
    elif customPreset == 'CG:Specular':
        presetLabel = 'CG: Specular'
        presetIcon = 'Shader.png'
        presetColor = colorsys.hsv_to_rgb(0.062, 1, 0.5)
        
    elif customPreset == 'Cleanup':
        presetLabel = 'Cleanup'
        presetIcon = 'DustBust.png'
        presetColor = colorsys.hsv_to_rgb(0.450, 0.44, 0.384)
        
    elif customPreset == 'Controllers':
    ...
    elif customPreset == 'Resources':
        presetLabel = 'Resources'
        presetIcon = 'Merge.png'
        presetColor = colorsys.hsv_to_rgb(0.682, 0, 0.298)
        
    elif customPreset == 'Rig_Removal':
    ...
    elif customPreset == 'Set_Extension':
    ...
    else: #customPreset == 'Transformations':
